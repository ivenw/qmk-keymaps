...
[_LOWER] = LAYOUT_planck_grid(
    _______, _______, _______, _______, _______, _______, KC_PEQL, KC_7,    KC_8,    KC_9,    KC_PPLS, KC_BSPC,
    _______, _______, _______, _______, _______, _______, KC_PAST, KC_4,    KC_5,    KC_6,    KC_PMNS, _______,
    _______, _______, _______, _______, _______, _______, KC_0,    KC_1,    KC_2,    KC_3,    KC_PSLS, KC_ENT,
